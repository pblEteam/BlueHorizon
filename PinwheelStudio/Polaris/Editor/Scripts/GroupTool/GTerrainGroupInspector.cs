    ...
    public class GTerrainGroupInspector : Editor
    {
        ...
        private void DrawShadingOverrideGUI()
        {
            ...
            context.AddItem(
                ...
                () =>
                {
                    GWizardWindow.ShowSetShaderPage(instance.GroupId);
                });
        ...
        private void DrawRenderingOverrideGUI()
        {
            ...
            GEditorCommon.Foldout(label, false, id, () =>
            {
                ...
                EditorGUILayout.BeginHorizontal();
                r.OverrideTreeLod1Start = EditorGUILayout.Toggle(r.OverrideTreeLod1Start, GUILayout.Width(TOGGLE_WIDTH));
                r.TreeLod1Start = EditorGUILayout.Slider("LOD 1 Start", r.TreeLod1Start, 0f, GCommon.MAX_TREE_DISTANCE);
                EditorGUILayout.EndHorizontal();
                ...
                GUI.enabled = true;
                GRuntimeSettings.Instance.renderingDefault.treeLodTransitionDistance = EditorGUILayout.Slider("LOD Transition Distance", GRuntimeSettings.Instance.renderingDefault.treeLodTransitionDistance, 0f, GCommon.FOLIAGE_LOD_TRANSITION_MAX);
                EditorGUILayout.EndHorizontal();
                ...
                EditorGUILayout.Toggle(true, GUILayout.Width(TOGGLE_WIDTH));
                GUI.enabled = true;
                GRuntimeSettings.Instance.renderingDefault.treeCullBias = EditorGUILayout.Slider("Cull Bias", GRuntimeSettings.Instance.renderingDefault.treeCullBias, 0f, GCommon.CULL_BIAS_MAX);
                EditorGUILayout.EndHorizontal();
                ...
                EditorGUILayout.BeginHorizontal();
                r.OverrideGrassLod1Start = EditorGUILayout.Toggle(r.OverrideGrassLod1Start, GUILayout.Width(TOGGLE_WIDTH));
                r.GrassLod1Start = EditorGUILayout.Slider("LOD 1 Start", r.GrassLod1Start, 0f, GCommon.MAX_GRASS_DISTANCE);
                EditorGUILayout.EndHorizontal();
                ...
                EditorGUILayout.Toggle(true, GUILayout.Width(TOGGLE_WIDTH));
                GUI.enabled = true;
                GRuntimeSettings.Instance.renderingDefault.grassLodTransitionDistance = EditorGUILayout.Slider("LOD Transition Distance", GRuntimeSettings.Instance.renderingDefault.grassLodTransitionDistance, 0f, GCommon.FOLIAGE_LOD_TRANSITION_MAX);
                EditorGUILayout.EndHorizontal();
