...
namespace Pinwheel.Griffin.SplineTool
{
    ...
    public class GPathPainterInspector : Editor
    {
        ...
        private class GSplineMeshGUI
        {
            ...
            public static readonly string ID = "spline-path-painter-mesh";
        ...
        {
            List<GOverlapTestResult> sweepTest = instance.SplineCreator.SweepTest(instance.Curviness, instance.Width, instance.FalloffWidth);
