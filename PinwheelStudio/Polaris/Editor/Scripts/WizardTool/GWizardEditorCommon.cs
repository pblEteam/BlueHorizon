...
namespace Pinwheel.Griffin.Wizard
{
    ...
    {
        public static void CheckForUrpFirstTimeImport()
        {
        ...
        public static void DrawMaterialSettingsGUI()
        {
            ...
            if (GEditorSettings.Instance.wizardTools.texturingModel == GTexturingModel.Splat)
            {
                ...
                if (GCommon.CurrentRenderPipeline == GRenderPipelineType.Universal &&
                    GEditorSettings.Instance.wizardTools.splatsModel != GSplatsModel.Splats4)
                {
                    EditorGUILayout.LabelField(" ", "It's recommended to use Splats4 on mobile platforms.", GEditorCommon.WarningLabel);
                }
#endif
            }
        }
