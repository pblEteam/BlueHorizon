...
namespace Pinwheel.Griffin.BillboardTool
{
    public class GBillboardEditor : GTwoPaneWindowWindow
    {
        ...
        public string srcTextureProps = "_MainTex";
        public string desTextureProps = "_MainTex";
        public string srcColorProps = "_Color";
        public string desColorProps = "_Color";
        public int cellIndex = 0;
        public List<Vector2> vertices = new List<Vector2>(new Vector2[] { new Vector2(0.01f, 0.01f), new Vector2(0.01f, 0.99f), new Vector2(0.99f, 0.99f), new Vector2(0.99f, 0.01f) });
        public int selectedVertexIndex = -1;
        public float vertexClickDistance = 10;
        public ushort[] tris = new ushort[0];
