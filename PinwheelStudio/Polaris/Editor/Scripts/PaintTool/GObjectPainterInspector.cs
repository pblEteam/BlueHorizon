...
namespace Pinwheel.Griffin.PaintTool
{
    ...
    public class GObjectPainterInspector : Editor
    {
        ...
        private class GObjectSelectionGUI
        {
            ...
            public static readonly string NO_OBJECT_FOUND = "Drop Game Objects to the boxes below.";
        ...
        GObjectPaintModeRadialSelectorProvider radialSelectorProvider = new GObjectPaintModeRadialSelectorProvider();
        ...
        private void HandlePaintModeSelector()
        {
            ...
            if (showRadialSelector)
            {
                painter.Mode = GEditorCommon.RadialSelectorEnum<GObjectPaintingMode>(painter.Mode, radialSelectorCenter, radialSelectorProvider, GEditorCommon.DefaultRadialSelectorStyle);
            }
        }
