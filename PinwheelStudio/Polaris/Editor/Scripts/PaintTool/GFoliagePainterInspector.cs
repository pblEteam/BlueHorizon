    ...
    public class GFoliagePainterInspector : Editor
    {
        ...
        private void DrawTreeSelectionGUI()
        {
            GEditorCommon.Foldout(GTreeGUI.LABEL, true, GTreeGUI.ID, () =>
            {
                ...
                EditorGUILayout.LabelField("Assign a Tree Prototype Group to the terrain to display tree here.", GEditorCommon.WordWrapItalicLabel);
                GEditorCommon.DrawLinks("Learn more", "https://docs.google.com/document/d/1rbHv8CW_QoHdCEaj98xq_V4S_gdWbbmY9-kQGM8qnpM/edit#heading=h.ft36k6vrb5pg");
            });
        }
        ...
        private void DrawGrassSelectionGUI()
        {
            GEditorCommon.Foldout(GGrassGUI.LABEL, true, GGrassGUI.ID, () =>
            {
                ...
                GEditorCommon.Separator();
                EditorGUILayout.LabelField("Assign a Grass Prototype Group to the terrain to display grass here.", GEditorCommon.WordWrapItalicLabel);
                GEditorCommon.DrawLinks("Learn more", "https://docs.google.com/document/d/1rbHv8CW_QoHdCEaj98xq_V4S_gdWbbmY9-kQGM8qnpM/edit#heading=h.ddi7l7ag8rvo");
            });
        }
        ...
        private class GBrushGUI
        {
            ...
            public static readonly GUIContent SHORTCUT_HINT = new GUIContent("Press A/S/D/C in Scene View to adjust Radius/Rotation/Density/Scatter.");
        ...
        GFoliagePaintModeRadialSelectorProvider radialSelectorProvider = new GFoliagePaintModeRadialSelectorProvider();
        ...
        private void HandlePaintModeSelector()
        {
            ...
            if (showRadialSelector)
            {
                painter.Mode = GEditorCommon.RadialSelectorEnum<GFoliagePaintingMode>(painter.Mode, radialSelectorCenter, radialSelectorProvider, GEditorCommon.DefaultRadialSelectorStyle);
            }
        }

        bool showRadiusAdjuster = false;
        bool showRotationAdjuster = false;
        bool showDensityAdjuster = false;
        ...
        private void HandleBrushAdjusters()
        {
            ...
            if (showDensityAdjuster)
            {
                painter.BrushDensity = (int)GEditorCommon.RadialFloatField("Density", painter.BrushDensity, brushAdjusterCenter, GEditorCommon.DefaultRadialFloatFieldStyle);
            }
