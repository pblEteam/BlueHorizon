...
namespace Pinwheel.Griffin
{
    ...
    public class GStylizedTerrainInspector : Editor
    {
        ...
        {
            EditorGUILayout.LabelField(GBaseGUI.VERSION, GVersionInfo.Code);
        ...
        {
            public static readonly GUIContent LABEL = new GUIContent("Geometry", GEditorSkin.Instance.GetTexture("MeshIcon"));
        ...
        {
            public static readonly GUIContent LABEL = new GUIContent("Material & Texture", GEditorSkin.Instance.GetTexture("SmoothnessIcon"));
            ...
            public static readonly string HEADER_STREAMS = "Streams";
            public static readonly GUIContent STREAM_MAP_RESOLUTION = new GUIContent("Stream Map Resolution", "Size of the Stream Map in pixel");
        ...
        private void DrawShadingGUI()
        {
            ...
            menu.AddItem(
                ...
                false,
                () => { data.Shading.UpdateMaterials(); terrain.TerrainData.SetDirty(GTerrainData.DirtyFlags.Shading); });
            menu.AddItem(
                GShadingGUI.CONTEXT_SET_SHADER,
                false,
                () => { GWizardWindow.ShowSetShaderPage(terrain); });
            ...
            GEditorCommon.Foldout(GShadingGUI.LABEL, false, GShadingGUI.ID, () =>
            {
                ...
                if (settings.ShadingSystem == GShadingSystem.MicroSplat)
                {
                    GEditorCommon.Header(GShadingGUI.HEADER_STREAMS);
                    settings.StreamMapResolution = EditorGUILayout.DelayedIntField(GShadingGUI.STREAM_MAP_RESOLUTION, settings.StreamMapResolution);
                }
#endif
        ...
        {
            public static readonly GUIContent LABEL = new GUIContent("Rendering", GEditorSkin.Instance.GetTexture("RenderingIcon"));
            ...
            public static readonly GUIContent TREE_LOD1_START = new GUIContent("LOD 1 Start", "Minimum distance from the camera where trees begin to be rendered as LOD1");
            ...
            public static readonly GUIContent TREE_LOD_TRANSITION_DISTANCE = new GUIContent("*LOD Transition Distance", "(Global) The distance from where it start to transition between LODs");
            public static readonly GUIContent TREE_CULL_BIAS = new GUIContent("*Cull Bias", "(Global) Bias the tree culling to prevent popping shadow");
            public static readonly GUIContent DRAW_FOLIAGE_ON_MAIN_CAMERA_ONLY = new GUIContent("*Main Camera Only", "Only draw tree/grass on the main camera");
            public static readonly GUIContent DRAW_FOLIAGE_MAIN_CAM_WARNING = new GUIContent("Foliage is currently visible in the Main Camera view only.");
            public static readonly GUIContent DRAW_FOLIAGE_ALL_CAM = new GUIContent("Draw On All Cameras");
            ...
            public static readonly GUIContent GRASSS_LOD1_START = new GUIContent("LOD 1 Start", "Minimum distance from the camera where grass begin to be rendered as LOD1");
            ...
            public static readonly GUIContent GRASS_LOD_TRANSITION_DISTANCE = new GUIContent("*LOD Transition Distance", "(Global) The distance from where it start to transition between LODs");
            public static readonly GUIContent GRASS_CULL_BIAS = new GUIContent("*Cull Bias", "(Global) Bias the grass culling to prevent popping grass");
        ...
        private void DrawRenderingGUI()
        {
            ...
            GEditorCommon.Foldout(GRenderingGUI.LABEL, false, GRenderingGUI.ID, () =>
            {
                ...
                settings.TreeLod1Start = EditorGUILayout.Slider(GRenderingGUI.TREE_LOD1_START, settings.TreeLod1Start, 0f, GCommon.MAX_TREE_DISTANCE);
                ...
                GRuntimeSettings.Instance.renderingDefault.treeLodTransitionDistance = EditorGUILayout.Slider(GRenderingGUI.TREE_LOD_TRANSITION_DISTANCE, GRuntimeSettings.Instance.renderingDefault.treeLodTransitionDistance, 0f, GCommon.FOLIAGE_LOD_TRANSITION_MAX);
                GRuntimeSettings.Instance.renderingDefault.treeCullBias = EditorGUILayout.Slider(GRenderingGUI.TREE_CULL_BIAS, GRuntimeSettings.Instance.renderingDefault.treeCullBias, 0f, GCommon.CULL_BIAS_MAX);
                ...
                settings.GrassLod1Start = EditorGUILayout.Slider(GRenderingGUI.GRASSS_LOD1_START, settings.GrassLod1Start, 0f, GCommon.MAX_GRASS_DISTANCE);
                ...
                GRuntimeSettings.Instance.renderingDefault.grassLodTransitionDistance = EditorGUILayout.Slider(GRenderingGUI.GRASS_LOD_TRANSITION_DISTANCE, GRuntimeSettings.Instance.renderingDefault.grassLodTransitionDistance, 0f, GCommon.FOLIAGE_LOD_TRANSITION_MAX);
                ...
                if (GRuntimeSettings.Instance.renderingDefault.drawFoliageOnMainCameraOnly)
                {
                    ...
                    r = new RectOffset(4, 4, 4, 4).Add(EditorGUI.IndentedRect(r));
                    GEditorCommon.DrawOutlineBox(r, GEditorCommon.WarningLabel.normal.textColor);

                    EditorGUILayout.LabelField(GRenderingGUI.DRAW_FOLIAGE_MAIN_CAM_WARNING.text, GEditorCommon.WarningLabel);

                    Rect buttonRect = EditorGUI.IndentedRect(EditorGUILayout.GetControlRect());
                    if (GUI.Button(buttonRect, GRenderingGUI.DRAW_FOLIAGE_ALL_CAM.text))
                    {
                        GRuntimeSettings.Instance.renderingDefault.drawFoliageOnMainCameraOnly = false;
                    }
        ...
        {
            public static readonly GUIContent LABEL = new GUIContent("Foliage", GEditorSkin.Instance.GetTexture("PaintTreeIcon"));
        ...
        {
            public static readonly GUIContent LABEL = new GUIContent("Mask", GEditorSkin.Instance.GetTexture("MaskIcon"));
        ...
        private class GDataGUI
        {
            ...
            public static readonly GUIContent LABEL = new GUIContent("Data", GEditorSkin.Instance.GetTexture("ExportImportIcon"));
        ...
        {
            public static readonly GUIContent LABEL = new GUIContent("Neighbor Tiles", GEditorSkin.Instance.GetTexture("SeamIcon"));
        ...
        {
            public static readonly GUIContent LABEL = new GUIContent("Statistics", GEditorSkin.Instance.GetTexture("StatsIcon"));
            ...
            public static readonly string MEM_FORMAT = "0.0 KB";
        }
        ...
        {
            public static readonly GUIContent LABEL = new GUIContent("Procedural Terrain", GEditorSkin.Instance.GetTexture("VistaIcon"));
