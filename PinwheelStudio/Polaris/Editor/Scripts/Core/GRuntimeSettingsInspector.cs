    ...
    public class GRuntimeSettingsInspector : Editor
    {
        ...
        private void DrawRenderingDefaultSettings()
        {
            ...
            GEditorCommon.Foldout(label, false, id, () =>
            {
                ...
                instance.renderingDefault.treeLod1Start = EditorGUILayout.Slider("Lod 1 Start", instance.renderingDefault.treeLod1Start, 0f, GCommon.MAX_TREE_DISTANCE);
                ...
                instance.renderingDefault.treeLodTransitionDistance = EditorGUILayout.Slider("Lod Transition Distance", instance.renderingDefault.treeLodTransitionDistance, 0f, GCommon.FOLIAGE_LOD_TRANSITION_MAX);
                instance.renderingDefault.treeCullBias = EditorGUILayout.Slider("Cull Bias", instance.renderingDefault.treeCullBias, 0f, 100f);
                instance.renderingDefault.treeLightProbeUsage = (LightProbeUsage)EditorGUILayout.EnumPopup("Light Probe Usage", instance.renderingDefault.treeLightProbeUsage);
                ...
                instance.renderingDefault.grassLod1Start = EditorGUILayout.Slider("Lod 1 Start", instance.renderingDefault.grassLod1Start, 0f, GCommon.MAX_GRASS_DISTANCE);
                ...
                instance.renderingDefault.grassLodTransitionDistance = EditorGUILayout.Slider("Lod Transition Distance", instance.renderingDefault.grassLodTransitionDistance, 0f, GCommon.FOLIAGE_LOD_TRANSITION_MAX);
                ...
                instance.renderingDefault.grassLightProbeUsage = (LightProbeUsage)EditorGUILayout.EnumPopup("Light Probe Usage", instance.renderingDefault.grassLightProbeUsage);
                instance.renderingDefault.grassUnloadInactiveCells = EditorGUILayout.Toggle("Unload Inactive Cells", instance.renderingDefault.grassUnloadInactiveCells);
                instance.renderingDefault.grassFrameCountToUnloadInactiveCells = EditorGUILayout.IntField("Frame Count To Unload Inactive Cells", instance.renderingDefault.grassFrameCountToUnloadInactiveCells);

                GEditorCommon.Header("Utility");
                instance.renderingDefault.drawFoliageOnMainCameraOnly = EditorGUILayout.Toggle("Draw Foliage on Main Camera only", instance.renderingDefault.drawFoliageOnMainCameraOnly);
            });
        }
        ...
        private void DrawGeometryGenerationSettings()
        {
            ...
            GEditorCommon.Foldout(label, false, id, () =>
            {
                ...
                GRuntimeSettings.Instance.geometryGeneration.useLodTransitionCurve = EditorGUILayout.Toggle("Use LOD Transition Curve", GRuntimeSettings.Instance.geometryGeneration.useLodTransitionCurve);
        ...
        private void DrawFoliageRenderingSettings()
        {
            ...
            GEditorCommon.Foldout(label, false, id, () =>
            {
                ...
                //GUI.enabled = false;
                //GEditorCommon.Header("Grass Meshes LOD 0");
                ...
                //GEditorCommon.Header("Grass Meshes LOD 1");
                //GRuntimeSettings.Instance.foliageRendering.grassQuadLod1 = EditorGUILayout.ObjectField("Quad", GRuntimeSettings.Instance.foliageRendering.grassQuadLod1, typeof(Mesh), false) as Mesh;
                //GRuntimeSettings.Instance.foliageRendering.grassCrossLod1 = EditorGUILayout.ObjectField("Cross", GRuntimeSettings.Instance.foliageRendering.grassCrossLod1, typeof(Mesh), false) as Mesh;
                //GRuntimeSettings.Instance.foliageRendering.grassTriCrossLod1 = EditorGUILayout.ObjectField("TriCross", GRuntimeSettings.Instance.foliageRendering.grassTriCrossLod1, typeof(Mesh), false) as Mesh;
                //GRuntimeSettings.Instance.foliageRendering.grassClumpLod1 = EditorGUILayout.ObjectField("Clump", GRuntimeSettings.Instance.foliageRendering.grassClumpLod1, typeof(Mesh), false) as Mesh;
                //GUI.enabled = true;
                #endregion
                ...
                GRuntimeSettings.Instance.foliageRendering.grassLod1Material = EditorGUILayout.ObjectField("Grass LOD1", GRuntimeSettings.Instance.foliageRendering.grassLod1Material, typeof(Material), false) as Material;
                ...
                GRuntimeSettings.Instance.foliageRendering.urpGrassLod1Material = EditorGUILayout.ObjectField("Grass LOD1", GRuntimeSettings.Instance.foliageRendering.urpGrassLod1Material, typeof(Material), false) as Material;
        ...
        private void DrawDefaultTexturesSettings()
        {
            ...
            GEditorCommon.Foldout(label, false, id, () =>
            {
                ...
                instance.defaultTextures.clearTexture = EditorGUILayout.ObjectField("Clear Texture", instance.defaultTextures.clearTexture, typeof(Texture2D), false) as Texture2D;
            });
        }
    }
}
