...
namespace Pinwheel.Griffin
{
    ...
    public partial class GEditorSettings : ScriptableObject
    {
        ...
        public class PaintToolsSettings
        {
            ...
            public bool enableSceneViewRadialSelector;
        }
        ...
        public class WizardToolsSettings
        {
            ...
            public bool linkTileSize;
            public bool linkTileCount;
        }
        ...
        {
            public Material[] GetDemoMaterials()
            {
                string[] guid = AssetDatabase.FindAssets("l:PolarisSampleMaterials");
                List<Material> mats = new List<Material>();
                foreach (string id in guid)
                {
                    Material m = AssetDatabase.LoadAssetAtPath<Material>(AssetDatabase.GUIDToAssetPath(id));
                    if (m != null)
                        mats.Add(m);
                }
                return mats.ToArray();
