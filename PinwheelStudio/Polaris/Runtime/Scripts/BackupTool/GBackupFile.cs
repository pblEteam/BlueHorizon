...
namespace Pinwheel.Griffin.BackupTool
{
    public static class GBackupFile
    {
        ...
        public const string STREAM_R_SUFFIX = "streammap_r";
        public const string STREAM_G_SUFFIX = "streammap_g";
        public const string STREAM_B_SUFFIX = "streammap_b";
        public const string STREAM_A_SUFFIX = "streammap_a";
#endif
