...
#pragma warning restore CS0649
        ...
        {
            Profiler.BeginSample("Polaris 3 - Render trees");
            try
            {
        ...
        private void CalculateQuickInstancesCullBox()
        {
            ...
            cullBoxMin.x = Mathf.Min(
                            Mathf.Min(Mathf.Min(nearFrustumCorners[0].x, nearFrustumCorners[1].x), Mathf.Min(nearFrustumCorners[2].x, nearFrustumCorners[3].x)),
                            Mathf.Min(Mathf.Min(farFrustumCorners[0].x, farFrustumCorners[1].x), Mathf.Min(farFrustumCorners[2].x, farFrustumCorners[3].x)));
            cullBoxMin.y = Mathf.Min(
                            Mathf.Min(Mathf.Min(nearFrustumCorners[0].y, nearFrustumCorners[1].y), Mathf.Min(nearFrustumCorners[2].y, nearFrustumCorners[3].y)),
                            Mathf.Min(Mathf.Min(farFrustumCorners[0].y, farFrustumCorners[1].y), Mathf.Min(farFrustumCorners[2].y, farFrustumCorners[3].y)));
            cullBoxMin.z = Mathf.Min(
                            Mathf.Min(Mathf.Min(nearFrustumCorners[0].z, nearFrustumCorners[1].z), Mathf.Min(nearFrustumCorners[2].z, nearFrustumCorners[3].z)),
                            Mathf.Min(Mathf.Min(farFrustumCorners[0].z, farFrustumCorners[1].z), Mathf.Min(farFrustumCorners[2].z, farFrustumCorners[3].z)));

            cullBoxMax.x = Mathf.Max(
                            Mathf.Max(Mathf.Max(nearFrustumCorners[0].x, nearFrustumCorners[1].x), Mathf.Max(nearFrustumCorners[2].x, nearFrustumCorners[3].x)),
                            Mathf.Max(Mathf.Max(farFrustumCorners[0].x, farFrustumCorners[1].x), Mathf.Max(farFrustumCorners[2].x, farFrustumCorners[3].x)));
            cullBoxMax.y = Mathf.Max(
                            Mathf.Max(Mathf.Max(nearFrustumCorners[0].y, nearFrustumCorners[1].y), Mathf.Max(nearFrustumCorners[2].y, nearFrustumCorners[3].y)),
                            Mathf.Max(Mathf.Max(farFrustumCorners[0].y, farFrustumCorners[1].y), Mathf.Max(farFrustumCorners[2].y, farFrustumCorners[3].y)));
            cullBoxMax.z = Mathf.Max(
                            Mathf.Max(Mathf.Max(nearFrustumCorners[0].z, nearFrustumCorners[1].z), Mathf.Max(nearFrustumCorners[2].z, nearFrustumCorners[3].z)),
                            Mathf.Max(Mathf.Max(farFrustumCorners[0].z, farFrustumCorners[1].z), Mathf.Max(farFrustumCorners[2].z, farFrustumCorners[3].z)));
        ...
        private void DrawInstanced(int prototypeIndex)
        {
            ...
            for (int i = 0; i <= count; ++i)
            {
                ...
                {
                    if (isBillboardNotNull && canDrawBillboardInstanced)
                    {
                        Graphics.DrawMeshInstanced(
                ...
                byte currentInstanceCullResult = instanceCullResults[i];
                if (currentInstanceCullResult == CULLED)
                    continue;
                if (instancePrototypeIndices[i] != prototypeIndex)
                    continue;

                if (currentInstanceCullResult == VISIBLE)
                {
                    if (canDrawInstanced)
                    {
                ...
                else if (currentInstanceCullResult == BILLBOARD && isBillboardNotNull)
                {
