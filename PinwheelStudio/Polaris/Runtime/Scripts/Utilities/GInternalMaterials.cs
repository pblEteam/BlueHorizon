...
namespace Pinwheel.Griffin
{
    public static class GInternalMaterials
    {
        ...
        private static Material vegetationDitheringMaskMaterial;
        public static Material VegetationDitheringMaskMaterial
        {
            get
            {
                if (vegetationDitheringMaskMaterial == null)
                {
                    vegetationDitheringMaskMaterial = new Material(GRuntimeSettings.Instance.internalShaders.vegetationDitheringMaskShader);
                }
                return vegetationDitheringMaskMaterial;
            }
        }
    }
}
