...
namespace Pinwheel.Griffin.BillboardTool
{
    public static class GBillboardCreator
    {
        ...
        private static void RenderPreviewAtlas(RenderTexture rt, GBillboardCreatorArgs args)
        {
            ...
            RenderTexture tempRt = new RenderTexture(Mathf.RoundToInt(viewPortSize.x * rt.width), Mathf.RoundToInt(viewPortSize.y * rt.height), 24, RenderTextureFormat.ARGB32, RenderTextureReadWrite.sRGB);
